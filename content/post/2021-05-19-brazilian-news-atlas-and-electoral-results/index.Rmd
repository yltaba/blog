...
In this post, we are interested in evaluate electoral outcomes from the so-called *news deserts*, municipalities without journalistic coverage by any specific vehicle based in the city. They are 58.4% of Brazilian cities, and are the home for 18% of total population.
...
```
By calculating the cumulative sum of the percentage of municipalities by each district magnitude size, we see that more than 83% of all Brazilian cities that have no local news vehicle elect only 9 city councilors. 
