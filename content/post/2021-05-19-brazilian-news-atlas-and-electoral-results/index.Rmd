...
This post consists in an Exploratory Data Analysis. The main objective here is to integrate data from *Atlas da Notícia*, a survey of local journalistic vehicles, with data from Brazilian local elections.
