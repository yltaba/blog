...
This project consists in an Exploratory Data Analysis. The main objective here is to integrate data from *Atlas da Notícia*, a survey of local journalistic vehicles, with data from local Brazilian elections, and generate insights about local electoral politics.
